...
(function () {
  ...
  /* ───── Portfolio back badge ─────
     Floating pill injected on every template page that links back to the
     studio portfolio. Self-contained: no markup or i18n keys required in the
     template, language follows the same Sage i18n state. */
  var BADGE_LABELS = {
