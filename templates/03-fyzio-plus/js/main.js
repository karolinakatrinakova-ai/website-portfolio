...
(function () {
  ...
  if (cb) {
    if (localStorage.getItem('webovky_cookies')) {
      cb.style.display = 'none';
    }
    cb.querySelectorAll('[data-cookie="accept"]').forEach(function (b) {
      b.addEventListener('click', function () {
        cb.style.display = 'none';
        localStorage.setItem('webovky_cookies', 'accepted');
      });
    });
    cb.querySelectorAll('[data-cookie="decline"]').forEach(function (b) {
      b.addEventListener('click', function () {
        cb.style.display = 'none';
        localStorage.setItem('webovky_cookies', 'declined');
      });
    });
  }
  ...
  if (io2 && !sessionStorage.getItem('webovky_intro')) {
    setTimeout(function () {
    ...
    function close2() {
      ...
      document.body.style.overflow = '';
      sessionStorage.setItem('webovky_intro', 'seen');
    }
  ...
  if (ab && localStorage.getItem('webovky_announcement_closed') === '1') {
  ...
  if (abClose) {
    abClose.addEventListener('click', function () {
      ab.style.display = 'none';
      localStorage.setItem('webovky_announcement_closed', '1');
    });
  }
